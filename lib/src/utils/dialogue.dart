...
class DownloadingDialog extends StatefulWidget {
  ...
  const DownloadingDialog({Key? key, required this.fileName, required this.request}) : super(key: key);
...
class _DownloadingDialogState extends State<DownloadingDialog> {
  ...
  decode(){
    ...
    if(fileName == 'svg' || fileName== 'png' || fileName == 'jpg' || fileName == 'pdf') {
  ...
  saveFile()async{
    data = await File('${PermissionManager().directory!.absolute.path}.${widget.fileName}.$fileName').writeAsBytes(base64decode);
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          data==null?const CircularProgressIndicator.adaptive():const Text('Downloaded',style: TextStyle(
            color: Colors.white
          ),),
          const SizedBox(
            height: 20,
