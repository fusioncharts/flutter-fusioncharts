...
class ScrollColumn2D extends StatefulWidget {
  const ScrollColumn2D({super.key});

  @override
  State<ScrollColumn2D> createState() => _ScrollColumn2DState();
}
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Fusion Charts - Scroll Column'),
        ),
        body: Column(
          children: [
