...
class ScrollLine2D extends StatefulWidget {
  const ScrollLine2D({super.key});

  @override
  State<ScrollLine2D> createState() => _ScrollLine2DState();
}

class _ScrollLine2DState extends State<ScrollLine2D> {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Fusion Charts - Scroll Line'),
        ),
        body: Column(
          children: [
