          ...
          child: Column(
            ...
            children: [
              InkWell(
                ...
                height: 40,
                child: InkWell(
                    child: const Text("Column-Line-Area (single)",
                        style: TextStyle(fontSize: 16)),
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>
                                const MultiSeriesSingleCombo()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    child: const Text("Column-Line-Area (dual)",
                        style: TextStyle(fontSize: 16)),
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>
                                const MultiSeriesDualCombo()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    child: const Text("Column3d-line-single y axis",
                        style: TextStyle(fontSize: 16)),
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>
                                const MSColumn3DLineSingleYAxis()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    child: const Text("Stacked Column3-line-single y axis",
                        style: TextStyle(fontSize: 16)),
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>
                                const StackedColumnLineSingleYAxis()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    child: const Text("Stacked Area Line Column",
                        style: TextStyle(fontSize: 16)),
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>
                                const StackedAreaLineColumn()))),
              )),
            ],
          ),
        ));
