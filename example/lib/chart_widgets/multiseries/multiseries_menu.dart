              ...
              InkWell(
                ...
                child: InkWell(
                    ...
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const ColumnMultiSeries()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    ...
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const LineMultiSeries()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    ...
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const BarMultiSeries()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    child: const Text("Overlapped Column",
                        style: TextStyle(fontSize: 16)),
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const OverlappedColumn()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    ...
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const AreaMultiSeries()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    child: const Text("Overlapped Bar",
                        style: TextStyle(fontSize: 16)),
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const OverlappedBar()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    ...
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const Marimekko()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    ...
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const Zoomline()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    child: const Text("Zoomline DY",
                        style: TextStyle(fontSize: 16)),
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const ZoomlineDY()))),
              )),
            ],
          ),
        ));
