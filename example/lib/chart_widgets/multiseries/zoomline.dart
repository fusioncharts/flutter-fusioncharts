...
class Zoomline extends StatefulWidget {
  const Zoomline({super.key});

  @override
  State<Zoomline> createState() => _ZoomlineState();
}

class _ZoomlineState extends State<Zoomline> {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Fusion Charts - Zoomline'),
        ),
        body: SizedBox(
