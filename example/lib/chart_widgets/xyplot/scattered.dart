...
class Scattered extends StatefulWidget {
  const Scattered({super.key});

  @override
  State<Scattered> createState() => _ScatteredState();
}

class _ScatteredState extends State<Scattered> {
