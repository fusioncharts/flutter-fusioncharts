...
class VerticalBulletGraph extends StatefulWidget {
  const VerticalBulletGraph({super.key});

  @override
  State<VerticalBulletGraph> createState() => _VerticalBulletGraphState();
}

class _VerticalBulletGraphState extends State<VerticalBulletGraph> {
