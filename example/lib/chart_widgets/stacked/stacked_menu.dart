              ...
              InkWell(
                ...
                child: InkWell(
                    ...
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const StackedColumn()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    ...
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const StackedBar()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    ...
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => const StackedArea2D()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    child: const Text("Multi Series Stacked Bar",
                        style: TextStyle(fontSize: 16)),
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>
                                const StackedBarMultiSeries()))),
              )),
              InkWell(
                  child: SizedBox(
                height: 40,
                child: InkWell(
                    child: const Text("Multi Series Stacked Column",
                        style: TextStyle(fontSize: 16)),
                    onTap: () => Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) =>
                                const StackedColumnMultiSeries()))),
              )),
            ],
          ),
        ));
