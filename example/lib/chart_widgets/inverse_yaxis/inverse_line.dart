...
class InverseLine extends StatefulWidget {
  const InverseLine({super.key});

  @override
  State<InverseLine> createState() => _InverseLineState();
}

class _InverseLineState extends State<InverseLine> {
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Fusion Charts - Inverse Line'),
        ),
        body: Column(
          children: [
