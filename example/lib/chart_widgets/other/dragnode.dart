...
class DragNode extends StatefulWidget {
  const DragNode({super.key});

  @override
  State<DragNode> createState() => _DragNodeState();
}
...
class _DragNodeState extends State<DragNode> {
  ...
  void initState() {
    ...
    Map<String, dynamic> chart = {
      "caption":
          "Project Plan for Construction of a Store (time duration in weeks)",
      "arrowatstart": "0",
      "arrowatend": "1",
      "viewMode": "1",
    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('Fusion Charts - DragNode'),
        ),
        body: Column(
          children: [
